...
6. **严格禁止使用平台违禁提示词**：
   - 禁止所有引擎类词汇：UnrealEngine5/UE5/CGI/Unity/工业光魔/皮克斯等
   - 禁止版权IP词汇：迪士尼/漫威/游戏角色/影视IP等
   - 禁止敏感内容词汇：暴力/色情/政治/医疗疗效宣传等
   - 完整违禁词库见同目录《违禁提示词库.md》，生成前必须对照检查
7. **违禁词自动替换规则**：
   - 「UnrealEngine5渲染」→ 替换为「电影级质感，写实光影」
   - 「CGI特效」→ 替换为「影视级画质，超高清渲染」
   - 其他违禁词根据场景替换为合规的等效描述
